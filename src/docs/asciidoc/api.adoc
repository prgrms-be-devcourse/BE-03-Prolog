...
//include::{snippets}/like-controller-test/like-save-api-test/request-fields.adoc[]
...
include::{snippets}/series-controller-test/find-series-by-title-test/response-fields.adoc[]
